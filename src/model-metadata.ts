...
export const modelMetadata: Record<string, ModelMetadata> = {
  ...
  "c4ai-aya-expanse-32b": { price: 2 * 0.5 + 1.5, isOpen: true, organization: "Cohere" },
  "c4ai-aya-expanse-8b": { price: 2 * 0.5 + 1.5, isOpen: true, organization: "Cohere" },
  ...
  "claude-3-5-haiku-20241022": { price: 2 * 0.8 + 4, organization: "Anthropic" },
  "claude-3-5-sonnet-20240620": { price: 2 * 3 + 15, organization: "Anthropic" },
  "claude-3-5-sonnet-20241022": { price: 2 * 3 + 15, organization: "Anthropic" },
  "claude-3-haiku-20240307": { price: 2 * 0.25 + 1.25, organization: "Anthropic" },
  ...
  "command-r-08-2024": { price: 2 * 0.1425 + 0.57, isOpen: true, organization: "Cohere" },
  "command-r-plus": { price: 2 * 2.85 + 14.25, isOpen: true, organization: "Cohere" },
  "command-r-plus-08-2024": { price: 2 * 2.375 + 9.5, isOpen: true, organization: "Cohere" },
  ...
  "gemini-1.5-flash-8b-001": { price: 2 * 0.0375 + 0.15, organization: "Google" },
  ...
  "gemma-2-27b-it": { price: 2 * 0.27 + 0.27, isOpen: true, organization: "Google Open" },
  "gemma-2-2b-it": { isOpen: true, organization: "Google Open" },
  "gemma-2-9b-it": { price: 2 * 0.03 + 0.06, isOpen: true, organization: "Google Open" },
  ...
  "llama-3-70b-instruct": { price: 2 * 0.23 + 0.4, isOpen: true, organization: "Meta" },
  "llama-3-8b-instruct": { price: 2 * 0.03 + 0.06, isOpen: true, organization: "Meta" },
  "llama-3.1-405b-instruct-bf16": { price: 2 * 3 + 3, isOpen: true, organization: "Meta" },
  "llama-3.1-405b-instruct-fp8": { price: 2 * 0.8 + 0.8, isOpen: true, organization: "Meta" },
  "llama-3.1-70b-instruct": { price: 2 * 0.12 + 0.3, isOpen: true, organization: "Meta" },
  "llama-3.1-8b-instruct": { price: 2 * 0.02 + 0.05, isOpen: true, organization: "Meta" },
  "llama-3.1-nemotron-51b-instruct": { isOpen: true, organization: "NVIDIA" },
  "llama-3.1-nemotron-70b-instruct": { price: 0.24 + 0.3, isOpen: true, organization: "NVIDIA" },
  "llama-3.2-1b-instruct": { price: 2 * 0.01 + 0.02, isOpen: true, organization: "Meta" },
  "llama-3.2-3b-instruct": { price: 2 * 0.015 + 0.025, isOpen: true, organization: "Meta" },
  "llama-3.2-vision-11b-instruct": { price: 2 * 0.055 + 0.055, isOpen: true, organization: "Meta" },
  "llama-3.2-vision-90b-instruct": { price: 2 * 0.35 + 0.4, isOpen: true, organization: "Meta" },
  "llama-3.3-70b-instruct": { price: 2 * 0.12 + 0.3, isOpen: true, organization: "Meta" },
  ...
  "ministral-8b-2410": { price: 2 * 0.1 + 0.1, isOpen: true, organization: "Mistral" },
  "mistral-7b-instruct": { price: 2 * 0.03 + 0.055, isOpen: true, organization: "Mistral" },
  "mistral-7b-instruct-v0.2": { price: 2 * 0.18 + 0.18, isOpen: true, organization: "Mistral" },
  ...
  "mixtral-8x22b-instruct-v0.1": { price: 2 * 0.9 + 0.9, isOpen: true, organization: "Mistral" },
  "mixtral-8x7b-instruct-v0.1": { price: 2 * 0.24 + 0.24, isOpen: true, organization: "Mistral" },
  ...
  "pixtral-12b-2409": { price: 2 * 0.1 + 0.1, isOpen: true, organization: "Mistral" },
  ...
  "qwen2-72b-instruct": { price: 2 * 0.34 + 0.39, isOpen: true, organization: "Qwen" },
  "qwen2-vl-72b": { price: 2 * 0.4 + 0.4, isOpen: true, organization: "Qwen" },
  "qwen2-vl-7b-instruct": { price: 2 * 0.1 + 0.1, isOpen: true, organization: "Qwen" },
  "qwen2.5-72b-instruct": { price: 2 * 0.23 + 0.4, isOpen: true, organization: "Qwen" },
  "qwen2.5-coder-32b-instruct": { price: 2 * 0.07 + 0.16, isOpen: true, organization: "Qwen" },
  "qwen2.5-plus-1127": { price: 2 * 3 + 9, organization: "Qwen" },
  "qwq-32b-preview": { price: 2 * 0.12 + 0.18, isOpen: true, organization: "Qwen" },

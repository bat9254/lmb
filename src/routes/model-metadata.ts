...
export const modelMetadata: Record<string, ModelMetadata> = {
  ...
  "deepseek-r1": { price: 2 * 0.55 + 2.19 * 5.7, isOpen: true, organization: "DeepSeek" },
  ...
  "gemini-2.0-flash-lite-preview-02-05": { price: 2 * 0.075 + 0.3, organization: "Google" },
  ...
  "gpt-4.5-preview-2025-02-27": { price: 2 * 75 + 150, organization: "OpenAI" },
  ...
  "o1-mini": { price: 2 * 3 + 12 * 2.1, organization: "OpenAI" },
  "o1-preview": { price: 2 * 15 + 60 * 4.3, organization: "OpenAI" },
  "o1-2024-12-17": { price: 2 * 15 + 60 * 3.9, organization: "OpenAI" },
  "o3-mini": { price: 2 * 1.1 + 4.4 * 4.3, organization: "OpenAI" },
  "o3-mini-high": { price: 2 * 1.1 + 4.4 * 9.5, organization: "OpenAI" },
  ...
  "qwen-plus-0828": { deprecated: true, price: 2 * 3 + 9, organization: "Qwen" },
  "qwen-plus-0125": { price: 2 * 0.4 + 1.2, organization: "Qwen" },
